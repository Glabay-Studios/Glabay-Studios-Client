...
public class SpriteLoader2 {
	...
	public static void loadSprites() {
		try {
			Buffer index = new Buffer(AssetUtils.INSTANCE.getResource("media_archive2.idx").openStream().readAllBytes());
			Buffer data = new Buffer(AssetUtils.INSTANCE.getResource("media_archive2.dat").openStream().readAllBytes());
