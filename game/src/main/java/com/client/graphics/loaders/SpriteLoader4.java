...
public class SpriteLoader4 {
	...
	public static void loadSprites() {
		try {
			Buffer index = new Buffer(AssetUtils.INSTANCE.getResource("media_archive4.idx").openStream().readAllBytes());
			Buffer data = new Buffer(AssetUtils.INSTANCE.getResource("media_archive4.dat").openStream().readAllBytes());
