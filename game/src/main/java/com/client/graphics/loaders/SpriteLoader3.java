...
public class SpriteLoader3 {
	...
	public static void loadSprites() {
		try {
			Buffer index = new Buffer(AssetUtils.INSTANCE.getResource("media_archive3.idx").openStream().readAllBytes());
			Buffer data = new Buffer(AssetUtils.INSTANCE.getResource("media_archive3.dat").openStream().readAllBytes());
