package com.client.mixins.menu;
...
public class RuneLiteMenuEntry implements MenuEntry, RSRuneLiteMenuEntry {
    ...
    public NPC getNpc() {
        ...
        NPC npc = null;
        MenuAction menuAction = this.getType();
        if (menuAction == MenuAction.NPC_FIRST_OPTION || menuAction == MenuAction.NPC_SECOND_OPTION || menuAction == MenuAction.NPC_THIRD_OPTION || menuAction == MenuAction.NPC_FOURTH_OPTION || menuAction == MenuAction.NPC_FIFTH_OPTION || menuAction == MenuAction.EXAMINE_NPC) {
            int identifier = this.getIdentifier();
