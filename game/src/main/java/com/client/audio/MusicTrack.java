...
public class MusicTrack extends Node implements RSMusicPatch {
	...
	MusicTrack(Buffer var1) {
		...
		var13 = var1.currentPosition; // L: 80
		var14 = var2 + var5 + var6 + var7 + var8 + var9 + var10 + var11 + var12; // L:
																					// 81
		for (var15 = 0; var15 < var14; ++var15) { // L: 82
			var1.readVarInt();
		}
		var4 += var1.currentPosition - var13; // L: 83
		var15 = var1.currentPosition; // L: 84
		int var16 = 0; // L: 85
		int var17 = 0; // L: 86
		int var18 = 0; // L: 87
		int var19 = 0; // L: 88
		...
		var29 = 0; // L: 114
		int var30 = var1.currentPosition; // L: 115
		var1.currentPosition += var26; // L: 116
		int var31 = var1.currentPosition; // L: 117
		var1.currentPosition += var11; // L: 118
		int var32 = var1.currentPosition; // L: 119
		var1.currentPosition += var10; // L: 120
		int var33 = var1.currentPosition; // L: 121
		var1.currentPosition += var9; // L: 122
		int var34 = var1.currentPosition; // L: 123
		var1.currentPosition += var16; // L: 124
		int var35 = var1.currentPosition; // L: 125
		var1.currentPosition += var18; // L: 126
		int var36 = var1.currentPosition; // L: 127
		var1.currentPosition += var20; // L: 128
		int var37 = var1.currentPosition; // L: 129
		var1.currentPosition += var7 + var8 + var11; // L: 130
		int var38 = var1.currentPosition; // L: 131
		var1.currentPosition += var7; // L: 132
		int var39 = var1.currentPosition; // L: 133
		var1.currentPosition += var27; // L: 134
		int var40 = var1.currentPosition; // L: 135
		var1.currentPosition += var8; // L: 136
		int var41 = var1.currentPosition; // L: 137
		var1.currentPosition += var17; // L: 138
		int var42 = var1.currentPosition; // L: 139
		var1.currentPosition += var19; // L: 140
		int var43 = var1.currentPosition; // L: 141
		var1.currentPosition += var21; // L: 142
		int var44 = var1.currentPosition; // L: 143
		var1.currentPosition += var12; // L: 144
		int var45 = var1.currentPosition; // L: 145
		var1.currentPosition += var9; // L: 146
		int var46 = var1.currentPosition; // L: 147
		var1.currentPosition += var22; // L: 148
		int var47 = var1.currentPosition; // L: 149
		var1.currentPosition += var23; // L: 150
		int var48 = var1.currentPosition; // L: 151
		var1.currentPosition += var24; // L: 152
		int var49 = var1.currentPosition; // L: 153
		var1.currentPosition += var25; // L: 154
		int var50 = var1.currentPosition; // L: 155
		var1.currentPosition += var5 * 3; // L: 156
		...
		var1.currentPosition = var13; // L: 164
		int var52 = 0; // L: 165
		int var53 = 0; // L: 166
		int var54 = 0; // L: 167
		int var55 = 0; // L: 168
		...
		label244 : for (int var60 = 0; var60 < var2; ++var60) { // L: 174
			...
			var51.currentPosition += 4; // L: 176
			int var61 = var51.currentPosition; // L: 177
			int var62 = -1; // L: 178
			while (true) {
				while (true) {
					...
					if (var64 == 7) { // L: 185
						...
						var51.writeLengthInt(var51.currentPosition - var61); // L: 269
						continue label244;
					}
					if (var64 == 23) { // L: 191
						if (var65) { // L: 192
