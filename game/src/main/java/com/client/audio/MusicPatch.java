...
public class MusicPatch extends Node implements RSMusicPatch {
	...
	MusicPatch(byte[] var1) {
		...
		int var3;
		for (var3 = 0; var2.payload[var3 + var2.currentPosition] != 0; ++var3) { // L: 29
																		// 30
		}
		...
		++var2.currentPosition; // L: 33
		++var3; // L: 34
		var5 = var2.currentPosition;
		var2.currentPosition += var3;
		int var6;
		for (var6 = 0; var2.payload[var6 + var2.currentPosition] != 0; ++var6) {
		}
		...
		++var2.currentPosition; // L: 41
		++var6; // L: 42
		var8 = var2.currentPosition; // L: 43
		var2.currentPosition += var6; // L: 44
		int var9;
		for (var9 = 0; var2.payload[var9 + var2.currentPosition] != 0; ++var9) { // L: 45
																		// 46
		}
		...
		int var17;
		for (var17 = 0; var2.payload[var17 + var2.currentPosition] != 0; ++var17) { // L:
																			// 83
																			// 84
		}
